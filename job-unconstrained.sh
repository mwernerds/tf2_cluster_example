...
# This job file is completely unconstrained and meant for debugging across the scheduler(send to specific nodes, etc.)
# use, for example, qsub -l nodes=tum4 -v CONFIG=configs/config.json job-unconstrained.sh
